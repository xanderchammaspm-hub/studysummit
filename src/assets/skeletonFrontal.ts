...
export const SIDE_BONES: Bone[] = [
  ...
  {
    zone: "vertebrae",
    d: "M 172,604 C 128,600 96,626 92,668 C 88,704 112,726 142,730 C 160,732 172,720 176,700 C 182,672 180,632 172,604 Z",
  },
  {
    zone: "vertebrae",
    d: "M 142,732 c -18,10 -22,34 -8,46 c 14,12 32,4 36,-14 Z",
  },
...
export const ZONE_BOXES: Record<BoneZone, { x: number; y: number; w: number; h: number }> = {
  skull: { x: 132, y: 14, w: 136, h: 176 },
  spine: { x: 60, y: 186, w: 280, h: 300 },
  vertebrae: { x: 84, y: 480, w: 232, h: 300 },
  limbs: { x: 44, y: 250, w: 312, h: 770 },
  feet: { x: 120, y: 1000, w: 160, h: 72 },
};
