...
1. **Syllabus dot-point checklists** — per subject/term, tick off NESA dot points; drives mastery %, mountain progress and XP.
2. **Daily plan** — a small "today" card: due assessments, exams within 14 days, weakest topics, and one Atlas suggest card 
